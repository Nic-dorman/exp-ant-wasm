...
/// On WASM, always defaults to 10 (no env var access).
...
/// Batch size for streaming decrypt chunk fetching (fixed at 10 on WASM).
#[cfg(target_arch = "wasm32")]
pub static STREAM_DECRYPT_BATCH_SIZE: LazyLock<usize> = LazyLock::new(|| 10);
